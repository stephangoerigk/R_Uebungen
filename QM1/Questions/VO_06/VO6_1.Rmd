...
* Das 95% Konfidenzintervall für den Mittelwert von Test 2 ist [`r lower_bound`; `r upper_bound`]
* Das 95% Konfidenzintervall für den Mittelwert von Test 1 ist [`r lower_bound_z`; `r upper_bound_z`]
* Das 95% Konfidenzintervall für den Mittelwert von Test 2 ist [`r lower_bound_w`; `r upper_bound_w`]
* Das 95% Konfidenzintervall für den Mittelwert von Test 1 ist [`r lower_bound_w2`; `r upper_bound_w2`] 
* Das 95% Konfidenzintervall für den Mittelwert von Test 1 ist [`r lower_bound_w3`; `r upper_bound_w3`] 
