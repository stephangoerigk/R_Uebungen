...
Dieses Paket gibt uns die Möglichkeit, `R` Aufgaben direkt über Ihren Browser  zu üben, ohne die Programme `R` und `R Studio` auf dem eigenen Computer installieren zu müssen. 
