...
Aufgabe Stichprobenbeschreibung (Work in progress...)


Schiefe Verteilung (Work in progress....)
...
quiz(
  question("Standardisierung...",
    answer("benötigt zunächst Mittelwert und Standardabweichung der Gesamtvariable", correct = TRUE),
    answer("benötigt Nominalskalenniveau"),
    answer("Wird als Hypothesentest genutzt"),
    answer("Kann zum Vergleich zweier auf unterschiedlichen Einheiten gemessenen Variablen genutzt werden", correct = TRUE), 
    answer("Kann zum Inbezugsetzen von Individuen unterschiedlicher Gruppen genutzt werden.", correct = TRUE),
    allow_retry = TRUE
  )
    )
```
...
```{r}
df = data.frame(Wert = c(2, 3, 4, 5, 6, 6, 10, 12, 14, 18))
