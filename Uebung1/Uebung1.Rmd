...
patienten_Daten = data.frame(
  ...
  PWB_ges = round(rnorm(n = 100, mean = 168, sd = 13),0)
)
...
quiz(
  question("Welche Aussagen zu den Ihnen angezeigten Daten stimmen?",
    ...
    answer("Der Datensatz enthält die Variablen ID, Diagnose, Geschlecht und PWB_ges", correct = TRUE),
...
Johanna ist leitende Psychologin auf Station 3 einer großen Psychiatrie.  Der Klinikdirektor möchte nun von Johanna wissen
