...
Mit dieser Übung möchten wir Ihnen eine erste Möglichkeit geben, sich mit dem Statistikprogramm R vertraut zu machen. Dazu verwenden wir das Paket `learnr`. Dieses Paket gibt Ihnen die Möglichkeit, direkt über Ihren Browser R Codes anzuwenden, ohne die Programme `R` und `R Studio` auf Ihren Rechnern installieren zu müssen. Zunächst werden wir Ihnen eine Einführung in die grundlegende Codiersprache und Funktionalität von `R` geben damit Sie dann im späteren Verlauf des Semesters die behandelten statistischen Analysen direkt in R Codiersprache ausprobieren können.
