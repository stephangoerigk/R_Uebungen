...
**Hinweis: Auch die SAS finden Sie auf studynet im Ordner "Fragebögen".*</font>**
...
table(smartphone$groups)

table(smartphone$Gender[smartphone$groups == "No Training"])
table(smartphone$Gender[smartphone$groups == "Training"])
...
```{r Einheit_2_MC_1, message = FALSE, warning=FALSE}
exams2learnr("/Questions/Einheit_2/Einheit_2_MC_1.Rmd", allow_retry = TRUE)
```

```{r quiz_projekt_2, echo = FALSE}

quiz(
  question("**Aufgabe 2:** Bestimmen Sie - differenziert nach den jeweiligen Gruppen *Training* und *No Training* - das durchschnittliche Alter der ProbandInnen. Wählen Sie im Folgenden die Antwortalternative aus, die diesen Wert im wissenschaftlichen Kontext korrekt und vollständig darstellt.",
    answer(""),
    answer("", correct = TRUE),
    answer(""),
    answer(""),
