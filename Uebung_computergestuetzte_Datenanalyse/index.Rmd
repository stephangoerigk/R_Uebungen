...
# Den veränderten Datensatz als CSV-Datei speichern
write.csv(smartphone, file = "smartphone_veraendert.csv", row.names = FALSE)
...
- Differenzwerte (t1 - t0) der beiden Skalen (GPS_diff, SAS_diff)
...
**Aufgabe 1:** Im folgenden Diagramm sind die Mittelwerte der Summenwerte der GPS und der SAS in Abhängigkeit des erhaltenen Trainings und der Zeitpunkte t0 und t1 grafisch dargestellt. 

Versuchen Sie, die Grafik nachzucoden.

[](images/Einheit_3_1.png)
