...
exams2learnr("/Uebung_computergestuetzte_Datenanalyse/Questions/Einheit_2/Einheit_2_MC_1.Rmd", allow_retry = TRUE)
```

```{r Einheit_2_MC_2, echo = FALSE}
exams2learnr("/Uebung_computergestuetzte_Datenanalyse/Questions/Einheit_2_MC_2.Rmd", allow_retry = TRUE)
```
