...
library(ggplot2)
ggplot(data = bipolar, aes(x = ISEL_sum, y = YMRS_sum)) + 
  geom_point(size = 1.0) +
  geom_smooth(method = "lm", color = "black", size = 0.5) + 
  labs(x = "Sozialer Support", y = "Symptomschwere Manie") +
  theme_bw() +
  theme(
...
# Grafische Darstellung
ggplot(data = bipolar, aes(x = ISEL_sum, y = YMRS_sum)) + 
  geom_point(size = 1.0, aes(shape = Groups)) +
  geom_smooth(method = "lm", color = "black", size = 0.5) + 
  labs(x = "Sozialer Support", y = "Symptomschwere Manie", shape = "Gruppen") +
  scale_shape_manual(values = c(1, 2), labels = c("Training", "Kein Training")) +
  theme_bw() +
  theme(
...
# Definiere die Farben entsprechend der korrekten Zuordnung
group_colors <- c("EW" = "red", "noEW" = "blue")

# Barplot
barplot_bipolar <- ggplot(bipolar, aes(x = Groups, y = YMRS_sum, fill = Groups)) +
  stat_summary(geom = "bar", fun = "mean", position = position_dodge2(.95)) +
  scale_x_discrete(labels = c("noEW" = "Control", "EW" = "Training")) +  
  scale_fill_manual(values = group_colors) +  # Korrekte Farbanpassung basierend auf den Daten-Levels
  labs(fill = "", y = "Manic Symptoms", x = "") +
  theme_bw() +
  theme(
    legend.position = "none", 
...
scatterplot_bipolar <- ggplot(data = bipolar, aes(x = ISEL_sum, y = YMRS_sum, color = Groups)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") + 
  scale_color_manual(values = group_colors) +  # Korrekte Farbanpassung basierend auf den Daten-Levels
  scale_x_discrete(labels = c("noEW" = "Control", "EW" = "Training")) +  
  labs(x = "Social Support", y = "Manic Symptoms", color = "Group") +  
  theme_bw() +
  theme(
...
# Gemeinsame Darstellung der Plots
ggarrange(barplot_bipolar, scatterplot_bipolar, 
          ncol = 2, nrow = 1, 
          common.legend = TRUE, legend = "bottom")
