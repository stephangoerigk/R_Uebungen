...
## Grundlegende Arithmetik und Datenformate 
...
Willkommen im Abschnitt **Grundlagen der Datenanalyse in R und RStudio**! 
...
## Datenvisualisierung und Hypothesentests 

Willkommen im Abschnitt **Datenvisualisierung und Hypothesentests in R und RStudio**! 

In diesem Abschnitt wird das in Kapitel zwei begonnene Projekt fortgesetzt. Ziel ist es, die z.T. bereits in Kapitel zwei ermittelten Werte grafisch darzustellen sowie Hypothesen mithilfe der Ihnen bekannten Methoden zu testen. Der zur Verfügung gestellte "bipolar"-Datensatz bleibt derselbe, enthält in der nun erneut über Github zu ladenden Version jedoch bereits die wichtigsten Werte:
