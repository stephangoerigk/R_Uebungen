...
```{r VO5_MC_12, message = FALSE, warning=FALSE}
exams2learnr("Questions/VO_05/VO5_MC_1.Rmd", allow_retry = TRUE)
```

```{r VO5_MC_13, message = FALSE, warning=FALSE}
exams2learnr("Questions/VO_05/VO5_MC_1.Rmd", allow_retry = TRUE)
```

```{r VO5_MC_14, message = FALSE, warning=FALSE}
exams2learnr("Questions/VO_05/VO5_MC_1.Rmd", allow_retry = TRUE)
```

```{r VO5_MC_15, message = FALSE, warning=FALSE}
exams2learnr("Questions/VO_05/VO5_MC_1.Rmd", allow_retry = TRUE)
```
