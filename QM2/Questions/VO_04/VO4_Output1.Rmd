...
Für `r n` Firmen wurden die Anzahl der Mitarbeiter $X$ und der Betrag der Ausgaben für die Weiterbildung $Y$ (in EUR) erfasst. Die statistische Zusammenfassung des Datensatzes lautet:
