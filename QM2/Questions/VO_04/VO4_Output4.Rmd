...
In einer psychologischen Studie wird untersucht, wie stark die Arbeitsbelastung einer Person ihr Stresserleben beeinflusst. Dazu wurden Daten von 100 berufstätigen Personen erhoben. Die Arbeitsbelastung wurde anhand eines validierten Fragebogens gemessen, wobei höhere Werte eine höhere Belastung anzeigen. Das Stresserleben wurde ebenfalls mit einem Fragebogen erfasst, der höhere Werte bei stärkerem Stresserleben liefert.

Ziel ist es, zu untersuchen, wie stark die Arbeitsbelastung das Stresserleben vorhersagen kann. Nach Ende der Datenerhebung erhalten Sie folgendes Ergebnis:
...
* Die Geradengleichung lautet: y = 21.32 + 0.05x
